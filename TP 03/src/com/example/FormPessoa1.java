...
public class FormPessoa1 extends JFrame {
    ...
    private void initComponents() {
        ...
        c.gridx=0; c.gridy=2; p.add(new JLabel("Sexo (M/F):"), c);
        c.gridx=1; p.add(txtSexo, c);
        ...
        btnOk.addActionListener(e -> {
            okButtonAction(txtNome.getText(), txtSexo.getText(), txtIdade.getText());
