...
public class FormPessoa3 extends JFrame {
    ...
    private JRadioButton rdbM = new JRadioButton("M");
    private JRadioButton rdbF = new JRadioButton("F");
    private ButtonGroup groupSexo = new ButtonGroup();
    private JTextField txtIdade = new JTextField(5);

    public FormPessoa3() {
        super("FormPessoa - Versão 3 (JRadioButton)");
    ...
    private void initComponents() {
        ...
        sexoPanel.add(rdbM); sexoPanel.add(rdbF);
        p.add(sexoPanel, c);
        ...
        btnOk.addActionListener(e -> {
            String sexo = rdbM.isSelected() ? "M" : rdbF.isSelected() ? "F" : "";
            okButtonAction(txtNome.getText(), sexo, txtIdade.getText());
